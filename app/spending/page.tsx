 ...
 console.log(budget_to_update, "........updated");
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div id="pop" style={{display:"none",width:'100vw', height:'105vh', backgroundColor:"rgba(0,0,0,0.5)", backdropFilter:"blur(5px)", position:"absolute", top:0, left:0, zIndex:99999999, justifyContent:"center", alignItems:"flex-start" }}>
