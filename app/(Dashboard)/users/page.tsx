...
export default function Dashboard() {
  const [tab, setTab] = useState("Managed Users");
  return (
    <>
      <div style={{ paddingTop: 20 }}>
        <div>
          ...
          {/* <p style={{ paddingTop: 10 }}>Manage Users</p> */}
        </div>
        ...
        <div style={{ display: "flex" }}>
          <div style={{ flex: 2 }}>
            {/* <Chart /> */}
            <div style={{ display: "flex" }}>
              {["Users",  "Settings"].map((el) => (
                <div
                  onClick={() => {
                    setTab(el);
                  }}
                  style={{ paddingTop: 20, fontSize: 18, paddingRight: 30 }}
                >
                  <p>{el}</p>
                </div>
              ))}
            ...
            <div style={{paddingTop:20, paddingBottom:50}}>
              ...
              {tab == "Managed Users" && <DataTable></DataTable>}
            </div>
